...
This project supports [LangSmith](https://smith.langchain.com/) for detailed tracing of the interview orchestration graph.

### Setup

1. Get your API key from [LangSmith](https://smith.langchain.com) → Settings → API Keys
...
- **Graph Execution**: Full execution timeline with state changes
- **Nodes**: Each node execution with inputs/outputs
- **LLM Calls**: Prompts, completions, tokens, latency
- **Routing Decisions**: Conditional edge evaluations
- **Errors**: Full stack traces with context

The frontend trace sidebar will show a "LangSmith" indicator when connected, with a link to view detailed traces in the LangSmith UI.

See [docs/langsmith-setup.md](./docs/langsmith-setup.md) for more details.
